...
export class R4Component {
  ...
  public players: {
    ...
    [
      ...
      { name: "Dissolver", create: "21.11.2024", headquarter: 27, vsPoints: 9375877795, marshal: 6, marshalPercent: "35.29%", desertStorm: 0, desertPercent: "0.00%" },
      { name: "Kasparov", create: "21.11.2024", headquarter: 26, vsPoints: 9316809835, marshal: 12, marshalPercent: "70.59%", desertStorm: 0, desertPercent: "0.00%" },
